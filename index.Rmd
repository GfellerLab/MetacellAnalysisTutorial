...
We provide examples of downstream analyses performed at the metacell level (e.g clustering, differential analysis, marker identification).
...
Finally, using the MCAT command line tool, we show how we can use metacells to **integrate and analyze around 580,000 cells** from 107 individuals distributed in 166 samples
