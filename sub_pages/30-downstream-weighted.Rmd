...
MC_list$PCA <- SuperCell::supercell_prcomp(
  Matrix::t(GetAssayData(MC.seurat, layer = "data")),
  genes.use = MC.seurat@misc$var_features, #VariableFeatures(MC.seurat),   or a new set of HVG can be computed
...
MC.all.markers <- supercell_FindAllMarkers(
  ge = GetAssayData(MC.seurat, layer = "data"),
