...
metacell.files <- sapply(datasets, FUN = function(x){paste0(root_dir,"/data/HLCA/datasets/",x,"/sup_mc/mc_adata.h5ad")})
...
meta.data.unsup <- readRDS(paste0(root_dir,"/data/HLCA/combined.mc.unsup.rds"))@meta.data
...
```{r fig.height=6, fig.width=14}
combined.mc.unsup <- readRDS(paste0(root_dir,"/data/HLCA/combined.mc.unsup.rds"))
