...
proj_name = ["cell_lines", "3k_pbmc", "cd34_multiome"][1]

annotation_label = {'cell_lines':'cell_line',
                   '3k_pbmc':'louvain',
                   'cd34_multiome':'celltype'}[proj_name] # name of annotation field (obs)
```
...
```{python seacell-load-data-noEval, eval = TRUE, echo = TRUE}
MC_tool = "SEACells"
proj_name = "3k_pbmc"
