...
ad = sc.read(os.path.join("/Users/admin/Documents/GitHub/MetacellAnalysisTutorial/data", proj_name, "singlecell_anndata_filtered.h5ad"))
...
import pickle
filename = '/Users/admin/Documents/GitHub/MetacellAnalysisTutorial/data/bmcite/saved_model.pkl'
with open(filename, 'rb') as file:
    model = pickle.load(file)
    
filename = '/Users/admin/Documents/GitHub/MetacellAnalysisTutorial/data/bmcite/saved_ad.pkl'
with open(filename, 'rb') as file:
    ad = pickle.load(file)
...
mc_ad.write_h5ad(os.path.join('/Users/admin/Documents/GitHub/MetacellAnalysisTutorial/data', proj_name, f'metacell_{MC_tool}.h5ad'))
```
...
library(anndata)
library(reticulate)
adata_mc <- read_h5ad(paste0(root_dir,"/data/", py$proj_name, "/metacell_SEACells.h5ad"))
...
saveRDS(MC.seurat, file = paste0(root_dir,'/data/', py$proj_name, '/metacell_SEACells.rds'))
```
