...
Now let's found the markers of the cluster 22 we've just identified.

```{r integrated_findmarkers}
DefaultAssay(combined.mc) <- "RNA"
markers22 <- FindMarkers(combined.mc, ident.1 = 22, only.pos = T)
head(markers22)
```
...
DimPlot(combined.mc[, combined.mc$integrated_snn_res.0.5 == 22],
