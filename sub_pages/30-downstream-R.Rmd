...
MC.seurat = readRDS(paste0(root_dir,'/data/', proj_name, '/metacell_', MC_tool,'.rds'))
```
...
p.sc <- SuperCell::supercell_GeneGenePlot(
  GetAssayData(sc_data, layer = "data"),
  gene_x = gene_x,
  gene_y = gene_y,
...
p.MC <- SuperCell::supercell_GeneGenePlot(GetAssayData(MC.seurat, layer = "data"),
                                          gene_x = gene_x,
                                          gene_y = gene_y,
